                    ...
                    <tr id="row-<?php echo $row['booking_id']; ?>">
                        ...
                        <td>
                            <a href="#" class="btn btn-info" 
                                data-toggle="modal" data-target="#myModal<?= $bokingno ?>"> View</a>
                        </td>
                    ...
                    if ($result1 && mysqli_num_rows($result1) > 0) {
                        while ($row1 = mysqli_fetch_assoc($result1)) {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-2 bgr">
                                        <span class="fw600">Payment Date</span><br>
                                    ...
                                    <div class="col-md-2 bgb">
                                        <span class="fw600">Date</span><br>
                                        <?php echo $row1['current_date']; ?>
                                    </div>
                                    <div class="col-md-2 bgr">
                                        <span class="fw600">Slip No</span><br>
                                ...
                                <div class="col-md-12 mb-2 mt-2">
                                    ...
                                    <div class="col-md-2 bgb">
                                        <span class="fw600">Payment By</span><br>
                                        <?php echo $row1['payment_by']; ?>
                                    </div>
                                    <div class="col-md-2 bgb">
                                        <span class="fw600">Drawn On</span><br>
                                        <?php echo $row1['drawn_on']; ?>
                                    </div>
                                    <div class="col-md-2 bgr">
                                        <span class="fw600">Total Ammount</span><br>
                                        <?php echo $row1['total_amout']; ?>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-6 bgr">
                                        <span class="fw600">Ammount in Word</span><br>
