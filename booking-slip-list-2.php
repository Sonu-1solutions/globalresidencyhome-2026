            ...
            <div id="printableArea<?php echo $count++ ?>">
              <div class="payment-slip" style="position: relative; width: 100%; margin: 0 auto;display: inline-block;">
                ...
                <input
                 ...
                 <p style="position: absolute;top: 31%;right: 2%;font-size: 16px;font-weight: 500;width: 150px;color: #000;"><?= $slipdata['current_date'];?></p>

                <p
                  style="position: absolute;top: 39.5%;left: 34%;font-size: 16px;font-weight: 500;width: 55%;color: #000;text-transform: capitalize;">
                  <?= $slipdata['receive_name']; ?> ( <?= $slipdata['registration_number']; ?>)
                </p>

                <input
                  style="position: absolute;top: 47%;left: 26%;font-size: 16px;font-weight: 500;border: none;background: transparent;padding: 0;width: 71%;"
                ...
                <input
                  style="position: absolute;bottom: 34.4%;left: 19%;font-size: 16px;font-weight: 500;border: none;background: transparent;padding: 0;width: 49%;"
                  type="text" value="<?= $slipdata['drawn_on']; ?>" readonly>

                <input
                  style="position: absolute;bottom: 34.3%;right: 30px;font-size: 16px;font-weight: 500;border: none;background: transparent;padding: 0;width: 22%;"
                  type="text" value="<?= $slipdata['payment_by_date']; ?>" readonly>



                <p
                  style="position: absolute;top: 68.8%;left: 21%;font-size: 16px;font-weight: 500;width: 76%;color: #000;">
                  <?php echo $slipdata['project_name']; ?>
                </p>

                <input
                  style="position: absolute;bottom: 19.5%;left: 16%;font-size: 16px;font-weight: 500;border: none;background: transparent;padding: 0;width: 30%;"
                ...
                <input
                  style="position: absolute;bottom: 8%;left: 10%;font-size: 20px;font-weight: 600;border: none;background: transparent;padding: 0;width: 15%;font-family: cursive;"
