            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-4">
                    ...
                    <select class="form-control" name="booking_no">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT booking_no FROM booking_master WHERE booking_status='Enabled'");
                ...
                <div class="col-md-2 mb-4" title="State">
                    ...
                    <select class="form-control" name="state">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_state FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
                ...
                <div class="col-md-2 mb-4" title="City">
                    ...
                    <select class="form-control" name="city">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_city FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
                ...
                <div class="col-md-2 mb-4" title="Project">
                    ...
                    <select class="form-control" name="project">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_project FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
                ...
                <div class="col-md-2 mb-4" title="Plot Type">
                    ...
                    <select class="form-control" name="plot_type">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_plottype FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
                ...
                <div class="col-md-2 mb-4" title="Plot Size">
                    ...
                    <select class="form-control" name="plot_size">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_plotsize FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
                ...
                <div class="col-md-2 mb-4" title="Plot Area">
                    ...
                    <select class="form-control" name="plot_area">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_plotarea FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
                ...
                <div class="col-md-2 mb-4" title="Plot Rate">
                    ...
                    <select class="form-control" name="plot_rate">
                        ...
                        <?php
                        $q = mysqli_query($con, "SELECT DISTINCT booking_plotrate FROM booking_master WHERE booking_status='Enabled'");
                        while ($row = mysqli_fetch_assoc($q)) {
