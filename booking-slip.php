                    ...
                    <div class="col-md-12 mt-3">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" class="form-control" id="advisorpercentage" name="percentage" value="">
                                <!-- <label class="fw-bold">Advisor Amount *</label> -->
                                <input type="hidden" class="form-control" id="advisoramountifany" name="ammount" value="">
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    ?>
                                        <div class="row" style="background:#ebebeb;">
                                            <div class="col-md-12 msgonly">
                                                <h4 class="text-center mt-4 mb-4">Advisor 70% of Total Amount Already Received</h4>
                                            </div>
                                        </div>
                                    <?php
                                        }
                                ...
                                <div class="above40percenttotalamt mb-4" style="display:none;">
                                    ...
                                    ?>
                                        <div class="row" style="">
                                            <div class="col-md-12 msgonly">
                                                <h4 class="text-center mt-4 mb-4">Advisor 100% of Total Amount Already Received</h4>
                                            </div>
                                        </div>
                                    <?php
                                        }
