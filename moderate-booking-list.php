...
// echo " | <b>A-Balance Amt : </b>".$totalpendingadvisor = $productdata['advisor_amount'] - $brokragetamotrec;
                                        ...
                                        <td class="d-flex">
                                            <a href="moderate-booking-view.php?booking_id=<?php echo $productdata['booking_id']; ?>"
                                                class="mr-1">
                                            ...
                                            <a href="moderate-booking-slip-list.php?slip_id=<?php echo $productdata['booking_no']; ?>"
