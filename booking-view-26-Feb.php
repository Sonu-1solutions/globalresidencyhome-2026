                    ...
                    <div class="row" style="border-top: 2px solid #000;">
                        ...
                        function numberToWords($number)
                        {
                            ...
                            if ($no == 0) {
                                ...
                                while ($no > 0) {
                                    // 2-2 digits except at hundreds place (10)
                                    $divider = ($i == 2) ? 10 : 100;
                                    ...
                                    if ($numberPart) {
                                        ...
                                        $hundred = ((($counter = count($str)) == 1) && $str[0]) ? ' and ' : '';
                                        if ($numberPart < 21) {
                                            $str[] = $words[$numberPart] . " " . $digits[$counter] . " " . $hundred;
                                        } else {
                                            $str[] = $words[floor($numberPart / 10) * 10] . " " . $words[$numberPart % 10] . " " . $digits[$counter] . " " . $hundred;
                                        }
                                    } else {
                                        $str[] = null;
                                    }
                            ...
                            return trim(preg_replace('/\s+/', ' ', $result)) . " Rupees" . $points . " Only";
                        }
                        ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="booking_no"
                                                                value="<?= htmlspecialchars($propertydata['booking_no']); ?>"
                                                                readonly required>
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label class="col-form-label">Allottee Name *</label>
                                                            <input type="text" class="form-control" name="allottee_name"
                                                                value="<?= htmlspecialchars($propertydata['booking_fname'] . ' ' . $propertydata['booking_lname']); ?>">
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="<?= htmlspecialchars($propertydata['booking_aadharno']); ?>">
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="booking_totalamt" class="form-control"
                                                                value="<?= $totalreceiveamt; ?>">
