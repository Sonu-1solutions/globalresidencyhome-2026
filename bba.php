    ...
    <div class="content">
        ...
        <style>
            ...
            @media print {
                ...
                /* Last page me extra blank page na aaye */
            ...
            /* Screen view (optional) */
            .print-page {
                border: 1px solid #ccc;
                padding: 0px 175px 115px;
                margin-bottom: 20px;
            }
            ...
            @media print {
                ...
                /* sirf print-section visible */
                #print-section,
                #print-section * {
                    visibility: visible;
                }

                /* print-section ko top-left pe lao */
                #print-section {
                    position: absolute;
                    left: 0;
                    top: 0;
        ...
        <button onclick="printOnlyPage()">Print Document</button>

        <div id="print-section">

            <div class="print-page">
                <!-- <h2>Page 1</h2> -->
                <h3 style="text-align: center; margin-top: 0px;">“GLOBAL RESIDENCY HOMES”</h3>
